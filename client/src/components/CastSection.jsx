...
import angelHuertaImage from "../photo assets/Cast Page/angel huerta.jpg";
import alexPetitImage from "../photo assets/Cast Page/Alex Petit headshot.jpg";
import julianFloresImage from "../photo assets/Cast Page/Julian Flores.jpeg";
import kealaNunesImage from "../photo assets/Cast Page/IMG_3095.jpeg";
...
const castMembers = [
    {
        ...
        name: "Angel Huerta",
        role: "Alex Portillo",
        image: angelHuertaImage,
        bio: `“My name is Angel Huerta and I am an actor out of Chula Vista,
...
films, agency interests and becoming SAG-Eligible.”`
    },
    {
        ...
        name: "Alex Petit",
        role: "Joe Terry",
        image: alexPetitImage,
        bio: `Alex Petit, a hilarious San Diego-based stand-up comic is the host and
...
Factory, American Comedy Company, and Mockingbird Improv.`
    },
    {
        ...
        name: "Keala Nunes",
        role: "Naomi Wright",
        image: kealaNunesImage,
        bio: `“My name is Keala Nunes, I am an actor and aspiring filmmaker studying
...
camera, and storytelling come together.”`
    },
    {
        id: "julian-flores",
        name: "Julián Flores",
        role: "George Portillo",
        image: julianFloresImage,
        bio: `Julián Flores is an actor from Tijuana who recently graduated with a
...
const CastSection = () => {
    const [visibleBioId, setVisibleBioId] = useState(null);

    const toggleBio = (memberId) => {
        setVisibleBioId((currentId) => currentId === memberId ? null : memberId);
    };
            ...
            <div className="cast-content">
                ...
                <div className="cast-grid">
                    {castMembers.map((member) => {
                        const isShowingBio = visibleBioId === member.id;
                            ...
                            <article className="cast-card" key={member.id}>
                                ...
                                {!isShowingBio ? (
                                    <button
                                        ...
                                        aria-label={`Show ${member.name} biography`}
                                    >
                                        <img
                                            src={member.image}
                                            alt={member.name}
